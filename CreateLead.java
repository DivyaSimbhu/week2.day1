...
public class CreateLead {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("//a[contains(text(),'CRM/SFA')]")).click();
		 ...
		 driver.findElement(By.xpath("//input[@id='createLeadForm_firstNameLocal']")).sendKeys("ddd");
		 ...
		 driver.findElement(By.xpath("//input[@id='createLeadForm_primaryEmail']")).sendKeys("divsim@gmail.com");
